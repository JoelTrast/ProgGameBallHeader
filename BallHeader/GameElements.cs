...
namespace BallHeader
{
    static class GameElements
    {
        ...
        static Texture2D[] framåt;
        static Texture2D[] bakåt;
        ...
        public static void LoadContent(ContentManager content, GameWindow window)
        {
            ...
            ball = new Ball(content.Load<Texture2D>("ball"), window.ClientBounds.Width / 2 - 32, 0, 0, 0);
            player = new Player(vänster, höger, window.ClientBounds.Width / 2, window.ClientBounds.Height, 4f, 0);
